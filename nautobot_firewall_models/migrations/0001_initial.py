    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "service_objects",
                    models.ManyToManyField(blank=True, to="nautobot_firewall_models.ServiceObject"),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="nautobot_firewall_models.addresspolicyobject",
                    ),
                ),
                (
                    "service",
        ...
        migrations.AddField(
            model_name="policyrule",
            name="source",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="nautobot_firewall_models.source"),
        ),
        migrations.AddField(
            model_name="policyrule",
            name="tags",
        ...
        migrations.AddField(
            model_name="policy",
            name="policy_rules",
            field=models.ManyToManyField(to="nautobot_firewall_models.PolicyRule"),
        ),
        migrations.AddField(
            model_name="iprange",
            name="vrf",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to="nautobot_firewall_models.AddressObjectGroup"),
        ),
        migrations.AddField(
            model_name="addresspolicyobject",
            name="address_objects",
            field=models.ManyToManyField(blank=True, to="nautobot_firewall_models.AddressObject"),
        ),
        migrations.AddField(
