"""Models for Nautobot Firewall Models."""
...
class IPRange(PrimaryModel):  # pylint: disable=too-many-ancestors
    """Base model for Nautobot Firewall Models app."""
    ...
    class Meta:
        ...
        # verbose_name_plural = "Nautobot Firewall Modelss"
